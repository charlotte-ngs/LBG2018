...
Note, it is important to distinguish between the observed or measured values of a trait which might be `red` coat color or $343$ kg of body weight and the traits themselves which are just coat color or body weight. 


### Genotypes and Phenotypes
In Livestock Breeding we are mainly concerned with changing animal populations at the genetic level. The reason why we are interested in changing a population genetically is because parents do not pass their phenotypes to their offspring. Parents pass a random sample of their genes to their offspring and for each offspring every parent does transmit a different sample of their genes. Therefore when looking at the set of all genes in a population this is the one unit that is passed on from one generation to the next generation. 
