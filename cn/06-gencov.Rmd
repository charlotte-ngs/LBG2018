...
The true breeding value ($a_i$) of animal $i$ can be decomposed into the true breeding values of animal $i$'s parents $s$ and $d$ and the mendelian sampling term $m_i$
...
\begin{tabular}{lll}
where  &       &  \\
       &  $a$  &  vector of true breeding values for all animals  \\
...
var(m_i)  &=  var(a_i) - {1\over 4} var(a_s) - {1\over 4} var(a_d) - {1\over 2} cov(a_s, a_d) \notag \\
          ...
          &=  \left(1 - {1\over 4}(F_s + F_d)\right) \sigma_a^2
