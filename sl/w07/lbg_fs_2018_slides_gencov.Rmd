...
where  &       &     \\
       ...
       &  $a$      &  vector of length $q$ of unknown random breeding values \\
...
vec_a <- rmddochelper::vecGetVecElem(psBaseElement = "a", pnVecLen = n_nr_ani, psResult = "latex")
### # residuals
...
* Assume $R = I * \sigma_e^2$ and we set $G = A * \sigma_a^2$
...
with $\lambda = \sigma_e^2 / \sigma_a^2$
...
* Offdiagonal elements $(A)_{ij} = cov(a_i, a_j) / \sigma_a^2$
* Symmetric
