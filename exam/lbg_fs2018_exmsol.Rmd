...
\begin{center}
\huge
Solutions To Final Exam\\ \vspace{1ex}
...
The predicted breeding value $\hat{a}_i$ based on the progeny performance is

$$\hat{a}_i = b(\bar{y_i} - \mu)$$
