...
vecExTopic[which(Date == format(as.Date("2018/12/14"), "%d.%m"))] <- "[Final Exam 2017](https://charlotte-ngs.github.io/LBGFS2018/ex/w13/lbg_hs2017_exam.pdf)"
...
vecExTopic[which(Date == format(as.Date("2018/12/14"), "%d.%m"))] <- "[Accuracy and Decomposition of PBV](https://charlotte-ngs.github.io/LBGFS2018/sol/w12/lbg_fs_2018_w12_sol11.pdf)"

# w14 
# vecExTopic[which(Date == format(as.Date("2018/12/21"), "%d.%m"))] <- "[Final Exam 2017](https://charlotte-ngs.github.io/LBGFS2018/sol/w13/lbg_hs2017_exmsol.pdf)"
